...
author_profile: true
---
You can explore my published work on [Google Scholar](https://scholar.google.com/citations?user=wMsDspYAAAAJ&hl=en). <br>
...
![image-center](bayesian_post.png){: .align-center style="max-width:60%;"}
...
![image-center](flood_change.png){: .align-center style="max-width:60%;"}
